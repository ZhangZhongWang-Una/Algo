...
from other.deepCTR.mmoe import MMOE
from other.deepCTR.evaluation import evaluate_deepctr
...
if __name__ == "__main__":
    ...
    data = pd.read_csv('../../data/origin/user_action.csv')

    feed = pd.read_csv('../../data/origin/feed_info.csv')
    ...
    # 2.count #unique features for each sparse field,and record dense feature field name计算每个稀疏字段的唯一特征，并记录密集特征字段名称
